...
2. Open the file and follow the instructions to install (you might need to allow "Install from Unknown Sources").
...
### Български
1. Изтеглете `.apk` файла на вашето Android устройство.
2. Отворете файла и следвайте инструкциите за инсталиране (може да се наложи да разрешите „Инсталиране от неизвестни източници“).
